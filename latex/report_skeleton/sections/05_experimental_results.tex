...
This dataset consists of two tables with approximately 3,300 and 3,700 records, generated with 50 entities each, 10\% overlap, and 70/80 records per entity (A/B). It serves as our primary artificial dataset for evaluating the Splink pipeline while maintaining computational tractability.
...
\begin{itemize}
    \item \texttt{smallest}: This dataset consists of two tables with approximately 3,300 and 3,700 records, generated with 50 entities each, 10\% overlap, and 30/35 records per entity.
    \item \texttt{low\_card}: 100 entities each, 10\% overlap, 5/5 records per entity (low intra-entity variation)
...
The smallest variant has 50 entities each, 10\% overlap, and cardinality 30/35 per entity.
...
\begin{figure}[H]
    ...
    \caption{Match weights chart for the smallest variant (50 entities, 10\% overlap, 30/35 cardinality).}
...
\paragraph{Dataset Description}
The low\_card variant has 100 entities each, 10\% overlap, and cardinality 5/5 per entity (low intra-entity variation).
...
\begin{figure}[H]
    ...
    \caption{Match weights chart for the low\_card variant (100 entities, 10\% overlap, 5/5 cardinality).}
